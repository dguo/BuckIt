...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.fb_pic'
        db.add_column('buckitapp_userprofile', 'fb_pic',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.fb_pic'
        db.delete_column('buckitapp_userprofile', 'fb_pic')
    ...
    models = {
        ...
        'buckitapp.userprofile': {
            ...
            'fb_pic': ('django.db.models.fields.CharField', [], {'max_length': '300', 'null': 'True'}),
