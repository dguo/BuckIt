...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('buckitapp_ownership', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('userProfile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['buckitapp.UserProfile'])),
    ...
    models = {
        ...
        'buckitapp.ownership': {
            ...
            'userProfile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['buckitapp.UserProfile']"})
        },
        'buckitapp.tag': {
